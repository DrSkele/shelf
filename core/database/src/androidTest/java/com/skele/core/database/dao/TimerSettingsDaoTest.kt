...
class TimerSettingsDaoTest : BaseDatabaseTest() {
    ...
    @Test
    fun timerSettingsDao_inserts_and_verifies_timer_settings() = runTest {
        // Create a timer settings entity
        val timerSettings = TimerSettingsEntity(
    ...
    @Test
    fun timerSettingsDao_updates_and_verifies_changes() = runTest {
        ...
        val updatedSettings = timerSettings.copy(
            id = id,
    ...
    @Test
    fun timerSettingsDao_deletes_and_verifies_removal() = runTest {
        // Insert a timer settings
        val timerSettings = TimerSettingsEntity(
            id = 0,
            description = "Test Timer",
    ...
    @Test
    fun timerSettingsDao_flow_operations_emit_expected_data() = runTest {
        // Insert a timer settings
        val timerSettings = TimerSettingsEntity(
            id = 0,
            description = "Test Timer",
    ...
    @Test
    fun timerSettingsDao_count_returns_correct_number() = runTest {
